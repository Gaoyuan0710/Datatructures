...
//fd1 = open("data.txt", O_RDONLY);
	...
	fd2 = open("/home/gaoyuan/source/asci.txt", O_WRONLY | O_CREAT | O_TRUNC, 0666);
...
void unpress()
{
	...
	fd2 = open("/home/gaoyuan/source/to.txt", O_WRONLY | O_CREAT | O_TRUNC, 0777);
	long long size;
	char longth[20];
...
int main(int argc, char *argv[])
{
	...
	head = read_file(head, "/home/gaoyuan/source/1.mp3");
	...
	trans_to_code(code, "/home/gaoyuan/source/1.mp3", "/home/gaoyuan/source/from.txt");

	press();
	unpress();

	Get_Language(hs, count, "/home/gaoyuan/source/to.txt", "/home/gaoyuan/source/2.mp3");
