...
(function(definition, undef) {
  ...
  var ads, crossdomainGet, domReadyListener, done, findAllAds, linksContent, ref, s, trackingAd, viewedHeight;
  ...
  */
  ...
  crossdomainGet = function(data) {
    ...
    return i.src = 'http://t.status.api.csdn.net/re?' + $.param(data);
  };
  if ($ === undef) {
    done = false;
